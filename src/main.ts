...
export {
    ...
    Cross as RechartsCross,
    Curve as RechartsCurve,
    Customized as RechartsCustomized,
    DefaultTooltipContent as RechartsDefaultTooltipContent,
    Dot as RechartsDot,
    ErrorBar as RechartsErrorBar,
    Funnel as RechartsFunnel,
    FunnelChart as RechartsFunnelChart,
    Global as RechartsGlobal,
